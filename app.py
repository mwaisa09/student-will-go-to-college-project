...
def main():
    st.title('Predictive Model Using Random Forest Classifier For Classification Student Want To Go College')
...
def predict(preprocessed_data, type_school, school_accreditation, gender, interest, residence, parent_was_in_college):
    ...
    if prediction[0] == 0:
        return 'The Student Will Not Go To College'
    else:
        return 'The Student Will Go To College'
